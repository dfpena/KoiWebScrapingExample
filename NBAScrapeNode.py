...
class StremeNode:
    ...
    def run(self,*args,**kwargs):
        self.kwargs=lxmlTable2Pandas5(**lxmlFindAll4(**lxmlParseUrl3(**lxmlFindAll2(**lxmlParseUrl1(**kwargs)))))
        return (self.kwargs)
...
class liveprocess:
    ...
    def run(self,expname):
        self.response=lxmlTable2Pandas5(**lxmlFindAll4(**lxmlParseUrl3(**lxmlFindAll2(**lxmlParseUrl1(**start())))))
